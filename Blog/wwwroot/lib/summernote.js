...
(function (factory) {
    ...
    var JSCodeButton = function (context) {
    ...
    var CSharpCodeButton = function (context) {
        var ui = $.summernote.ui;

        // create button
        var button = ui.button({
            contents: '<i class="fa fa-child"/> C#',
            tooltip: 'C#',
            click: function () {
                // invoke insertText method with 'hello' on editor module.
                var txt = getSelectedText();
                var code = getCode('C#', txt);
                context.invoke('editor.pasteHTML', code);
                $('pre code').each(function (i, block) {
                    hljs.highlightBlock(block);
                });
    ...
    var XMLCodeButton = function (context) {
        var ui = $.summernote.ui;

        // create button
        var button = ui.button({
            contents: '<i class="fa fa-child"/> XML',
            tooltip: 'XML',
            click: function () {
                // invoke insertText method with 'hello' on editor module.
                var txt = getSelectedText();
                var code = getCode('XML', txt);
                context.invoke('editor.pasteHTML', code);
                $('pre code').each(function (i, block) {
                    hljs.highlightBlock(block);
                });
    ...
    function getCode(codeName, text) {
        var resultTxt = "<pre><code class='" + codeName + "'>";
        if (codeName == 'XML') {
            text = text.replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;").replace(/"/g, "&quot;");
        }
        resultTxt += text + "</code></pre>";
        return resultTxt;
    }
        ...
        this.addToolbarButtons = function () {
            ...
            context.memo('button.code', function () {
                return ui.button({
                    className: 'btn-code',
                    contents: ui.icon(options.icons.arrowsAlt),
                    tooltip: lang.options.code,
                    click: context.createInvokeHandler('code.toggle')
                }).render();
            });
